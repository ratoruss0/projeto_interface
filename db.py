...
def _ensure_engine():
    ...
    # O detector de engine usa cache na primeira conexão bem-sucedida.
    # Se o MySQL cair e depois voltar, o serviço precisa ser reiniciado
    # para voltar a tentar conectar ao MySQL.
    if _engine:
        return _engine
